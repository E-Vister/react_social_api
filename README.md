...
Installation
-----------
Clone the repository to your PC, go to the project folder, text `npm update`, then `npm start` to start the server.
...
Documentation
-------------
Documentation for all available endpoints is provided below.

* [/auth](#auth)
    * *auth/me* [**[GET]**](#get-authme-response)
    * *auth/login* [**[POST]**](#post-authlogin-request) [**[DELETE]**](#delete-authlogin-response)
* [/follow](#follow)
    * */follow/{userId}* [**[GET]**](#get-followuserid-request) [**[POST]**](#post-followuserid-request) [**[DELETE]**](#delete-followuserid-request)
* [/profile](#profile)
    * */profile/{userId}* [**[GET]**](#get-profileuserid-request)
    * */profile/status/{userId}* [**[GET]**](#get-profilestatususerid-request)
    * */profile/status* [**[PUT]**](#put-profilestatus-request)
    * */profile/posts* [**[POST]**](#post-profileposts-request)
* [/users](#users)
    * */users* [**[GET]**](#get-users-request)
